#!/bin/bash
#Mau recode ya bgsd? Allah maha tau:)
#subscribe dolo janc*k : https://github.com/CL4Y0101
...
figlet *Adit Gans* |lolcat

echo $c "    _________________________________   ${endc}";
echo $c "   /                                 \  ${endc}";
echo $c "  /    https://github.com/CL4Y0101 \ ${endc}";
...
echo  "+ Author   : Cl4Y0101 $white                         + " |lolcat
echo  "+===========================================+" |lolcat
...
50) echo $r "Support Us"
apt update && apt upgrade -y
pkg install python2 -y
pkg install figlet
git clone https://github.com/MaulanaRyM/ACNv2
mv ACNv2 $HOME
cd $HOME/ACNv2
sh ACNv2.sh
...
00) echo "created by : <==Adit Gans and MaulanaRyM==>" |lolcat
exit
